...
export function flightIdGet$Plain(http: HttpClient, rootUrl: string, params: FlightIdGet$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<FlightRm>> {
